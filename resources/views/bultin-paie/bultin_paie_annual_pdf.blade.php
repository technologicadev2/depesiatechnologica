...
<head>
    <meta charset="UTF-8">
    <title>Bulletin de Paie Annuel</title>
    <style>
        body {
...
<body>
    ...
    <div class="bulletin-container">
        <div class="header-title">BULLETIN DE PAIE ANNUEL</div>
            ...
            <div class="info-cell">
                <table class="info-table">
                    <tr>
                        ...
                        <td class="info-value2">Année : {{ $period['year'] }}</td>
                    </tr>
                    <tr>
        ...
        <table class="payroll-table" style="border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount-cell">{{ $payroll['days_worked'] ?? 0 }}</td>
                    <td class="amount-cell"></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="amount-cell">
                        {{ ($payroll['joursFeriesTravaillesCount'] ?? 0) > 0
                ...
                {{-- Total des jours calculés --}}
                <tr class="category-row">
                    <td></td>
                    <td><strong>TOTAL DES JOURS CALCULES</strong></td>
                    <td class="amount-cell">{{ $payroll['jours_calcules'] ?? $payroll['days_worked'] ?? '-' }}</td>
                    <td class="amount-cell"></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="amount-cell">
                        {{ ($payroll['heurSuppPresencematin'] ?? 0) > 0 && isset($payroll['tauxHeureSupp'])
                            ? number_format($payroll['tauxHeureSupp'], 2, ',', ' ')
                            : '0' }}
                    </td>
                    <td class="amount-cell">
                        {{ ($payroll['heurSuppPresencematin'] ?? 0) > 0
                            ? number_format($payroll['heurSupp25'] ?? 0, 2, ',', ' ')
                            : '0' }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="amount-cell">
                        {{ number_format(($payroll['heurSuppPresencematinF'] ?? 0) + ($payroll['heurSuppPresenceNuit'] ?? 0), 2, ',', ' ') }}
                    </td>
                    <td class="amount-cell">
                        {{ (($payroll['heurSuppPresencematinF'] ?? 0) + ($payroll['heurSuppPresenceNuit'] ?? 0)) > 0 && isset($payroll['tauxHeureSupp'])
                            ? number_format($payroll['tauxHeureSupp'], 2, ',', ' ')
                            : '0' }}
                    </td>
                    <td class="amount-cell">
                        {{ (($payroll['heurSuppPresencematinF'] ?? 0) + ($payroll['heurSuppPresenceNuit'] ?? 0)) > 0
                            ? number_format($payroll['heurSupp50'] ?? 0, 2, ',', ' ')
                            : '0' }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="amount-cell">
                        {{ ($payroll['heurSuppPresenceNuitF'] ?? 0) > 0 && isset($payroll['tauxHeureSupp'])
                            ? number_format($payroll['tauxHeureSupp'], 2, ',', ' ')
                            : '0' }}
                    </td>
                    <td class="amount-cell">
                        {{ ($payroll['heurSuppPresenceNuitF'] ?? 0) > 0
                            ? number_format($payroll['heurSupp100'] ?? 0, 2, ',', ' ')
                            : '0' }}
                    </td>
                </tr>

                {{-- Salaire de base imposable (après supp) --}}
                <tr class="category-row">
                    <td>=</td>
                ...
                {{-- Prime représentation --}}
                <tr>
                    <td>+</td>
                    <td>Prime Représentation</td>
                    <td class="amount-cell">{{ number_format($payroll['representation_bonus_input'] ?? 0, 2, ',', ' ') }}</td>
                    <td class="amount-cell"></td>
                    <td class="amount-cell">{{ number_format($payroll['representation_bonus'] ?? 0, 2, ',', ' ') }}</td>
                </tr>
                ...
                {{-- Congés travaillés (si applicable) --}}
                ...
                {{-- Indemnité de perte d'emploi ← NOUVEAU --}}
                <tr>
                    <td>-</td>
